...
- [Release 0.1.8 Cairn policy updates](docs/plan/release-0.1.8-cairn-policy-updates.md): publish task/sub-task, interruption resume, Heavy Path test gate, Codex model inheritance, and recursive subagent policy updates.
