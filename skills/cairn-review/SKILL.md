...
4. Delegate independent review.
   ...
   - `worker`: verification command re-run.
...
MUST DO: Check both module evidence and surface evidence. Preserve proper nouns exactly. Use the OS locale for user-visible text.
MUST NOT DO: Edit files. Ask the user. Approve missing evidence.
